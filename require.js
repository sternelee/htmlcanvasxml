...
(function(ca) {
    ...
    function ha(b) {
        ...
        function r(a, e, b) {
            var f = a.id
              , n = j(k, f);
            if (s(p, f) && (!n || n.defineEmitComplete))
                "defined" === e && b(p[f]);
            else if (n = q(a),
            n.error && "error" === e)
                b(n.error);
        ...
        function x() {
            S.length && (ia.apply(A, [A.length, 0].concat(S)),
            S = [])
        }
        function y(a) {
            delete k[a];
        ...
        function F(a, e, b) {
            ...
            v(a.depMaps, function(f, c) {
                var d = f.id
                  , g = j(k, d);
                g && (!a.depMatched[c] && !b[d]) && (j(e, d) ? (a.defineDep(c, p[d]),
                a.check()) : F(g, e, b))
            }
            ),
            b[f] = !0)
        ...
        function D() {
            ...
            if (!X) {
                ...
                B(W, function(a) {
                    var i = a.map
                      , m = i.id;
                    if (a.enabled && (i.isDefine || c.push(a),
                    !a.error))
                        if (!a.inited && b)
                            g(m) ? h = e = !0 : (f.push(m),
                            d(m));
                        else if (!a.inited && (a.fetched && i.isDefine) && (h = !0,
                        !i.prefix))
                            return k = !1
                }
                );
                            ...
                            if (!this.defining) {
                                ...
                                if (1 > this.depCount && !this.defined) {
                                    if (G(c)) {
                                        ...
                                        f = c;
                                    this.exports = f;
                                    if (this.map.isDefine && !this.ignore && (p[b] = f,
                                    h.onResourceLoad))
            ...
            callPlugin: function() {
                ...
                r(d, "defined", t(this, function(f) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        g ? (this.map.url = i.nameToUrl(g),
                        this.load()) : (d = t(this, function(a) {
                            this.init([], function() {
                                return a
                            }
                            , null , {
        ...
        i = {
            ...
            makeRequire: function(a, e) {
                ...
                a || (g.undef = function(b) {
                    ...
                    e && (e.events.defined && (aa[b] = e.events),
                    y(b))
                }
                );
                return g
    ...
    if ("undefined" === typeof define) {
        ...
        "undefined" !== typeof require && !G(require) && (r = require,
        require = void 0);
        h = requirejs = function(b, c, d, g) {
            var u, m = "_";
            !H(b) && "string" !== typeof b && (u = b,
            H(c) ? (b = c,
            c = d,
            d = g) : b = []);
        ...
        h.load = function(b, c, d) {
            var g = b && b.config || {};
            if (z)
                return g = h.createNode(g, c, d),
                g.setAttribute("data-requirecontext", b.contextName),
                g.setAttribute("data-requiremodule", c),
                g.attachEvent && !(g.attachEvent.toString && 0 > g.attachEvent.toString().indexOf("[native code")) && !Z ? (O = !0,
                g.attachEvent("onreadystatechange", b.onScriptLoad)) : 
        ...
        define = function(b, c, d) {
            ...
            if (O) {
                if (!(g = L))
                    ...
                    g = P;
                g && (b || 
                (b = g.getAttribute("data-requiremodule")),
