...
var system = function (e) {
    if (e === void 0) { e = jquery_1["default"]; }
    var t = function () { };
    return t.ENV_DEV = "dev",
        ...
        t.isMobile = function () {
            var e = ["iphone", "android", "ipod", "ipad"], t = !1;
        ...
        t.isSupportCSS3Transform = function () {
            var t = e("<div></div>"), n = "scale(2,2)", r = ["-webkit-transform", "-moz-transform", "-o-transform", "-ms-transform", "transform"];
        ...
        t.inWechatBrowser = function () {
            var e = /MicroMessenger/i, t = navigator.userAgent;
            return e.test(t);
        },
        ...
        t.vendorJSProp = function (e, t) {
            ...
            if (e[t] != undefined)
                ...
                var r = t.slice(0, 1).toUpperCase() + t.slice(1, t.length), i = ["webkit", "moz", "o", "ms"];
...
var run_loop = function (e) {
    if (e === void 0) { e = system; }
    var t = function () { };
    return t.targets = [],
        t.timer = undefined,
        t.lastTS = 0,
        t.enterFrame = function () {
            var t = null, n = e.vendorJSProp(window, "requestAnimationFrame");
        ...
        t.onFire = function () {
            var e = (new Date).getTime(), n = (e - t.lastTS) / 1e3;
            for (var r = 0; r < t.targets.length; r++) {
                var i = t.targets[r], s = i.target;
...
var mat3 = function (e) {
    ...
    return t.rotateMat = function (e, n) {
        ...
        t.mat3With3Points = function (e, n) {
            var r = ((n[0].x - n[1].x) * (e[1].y - e[2].y) - (n[1].x - n[2].x) * (e[0].y - e[1].y)) / ((e[0].x - e[1].x) * (e[1].y - e[2].y) - (e[1].x - e[2].x) * (e[0].y - e[1].y)), i = ((n[0].x - n[1].x) * (e[0].x - e[2].x) - (n[0].x - n[2].x) * (e[0].x - e[1].x)) / ((e[0].x - e[2].x) * (e[0].y - e[1].y) - (e[0].x - e[1].x) * (e[0].y - e[2].y)), s = n[0].x - r * e[0].x - i * e[0].y, o = ((n[0].y - n[1].y) * (e[1].y - e[2].y) - (n[1].y - n[2].y) * (e[0].y - e[1].y)) / ((e[0].x - e[1].x) * (e[1].y - e[2].y) - (e[1].x - e[2].x) * (e[0].y - e[1].y)), u = ((n[0].y - n[1].y) * (e[0].x - e[2].x) - (n[0].y - n[2].y) * (e[0].x - e[1].x)) / ((e[0].x - e[2].x) * (e[0].y - e[1].y) - (e[0].x - e[1].x) * (e[0].y - e[2].y)), a = n[0].y - o * e[0].x - u * e[0].y;
        ...
        t.prototype.concatWith = function (e) {
            var n = this, r = n.a * e.a + n.b * e.c, i = n.a * e.b + n.b * e.d, s = n.c * e.a + n.d * e.c, o = n.c * e.b + n.d * e.d, u = n.tx * e.a + n.ty * e.c + e.tx, a = n.tx * e.b + n.ty * e.d + e.ty;
        ...
        t.prototype.inversion = function () {
            var e = this, t = e.clone();
            return t.inverse(),
                t;
        },
        t.prototype.inverse = function () {
            var e = this, t = e.determinant();
            if (t === 0)
                throw new Error("The matrix can not be inverse properly. " + e.toString());
            var n = 1 / t, r = e.d * n, i = -1 * e.b * n, s = -1 * e.c * n, o = e.a * n, u = (e.c * e.ty - e.d * e.tx) * n, a = -1 * (e.a * e.ty - e.b * e.tx) * n;
            e.a = r,
                e.b = i,
                e.c = s,
                e.d = o,
        ...
        t.prototype.adjoint = function () {
            var e = this, n = e.d, r = -1 * e.b, i = -1 * e.c, s = e.a, o = e.c * e.ty - e.d * e.tx, u = -1 * (e.a * e.ty - e.b * e.tx);
...
var render_engine = function (e, t, n, r, i, s, o, u) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = run_loop; }
    if (n === void 0) { n = system; }
    if (r === void 0) { r = mat3; }
    if (i === void 0) { i = vec2; }
    if (s === void 0) { s = touch_event; }
    if (o === void 0) { o = touch; }
    if (u === void 0) { u = text_align; }
    var a = function (n) {
        var r = this;
        r.stage = n,
            r.$body = e("body"),
    ...
    return a.prototype.stage = null,
        ...
        a.prototype.resize = function () {
            var t = this, n = e(window).width(), r = e(window).height();
        ...
        a.prototype.takePhoto = function (t, n, i) {
            ...
            var f = o[0].toDataURL(typeof i == "string" ? i : "image/png"), l = e("<img/>");
            l.load(function () {
                Boolean(n) && n(t, l[0]);
            }),
                l.attr("src", f);
        ...
        a.prototype.renderContainer = function (e, t, n, r) {
            var i = this, s = t.visibleSubViews();
        ...
        a.prototype.renderMultipleLineText = function (e, t) {
            ...
            if (n.length > 0 && t.width() > 0) {
                ...
                for (var c = 0; c < r.length; c++) {
                    var h = r[c], p = e.measureText(h), d = 0;
        ...
        a.prototype.renderSingleLineText = function (e, t) {
            ...
            var n = e.measureText(t.text()), r = 0;
        ...
        a.prototype.configEvents = function () {
            ...
            e.$canvas.bind(n.isTouchDevice() ? "touchstart" : "mousedown", function (t) {
                var r = function (t) {
                    ...
                    var o = e.createTouchEvent(i), u = new s(e.stage, r, o);
    ...
    return n.listeners = [],
        n.addListener = function (t, r, i, s) {
            ...
            for (var o = 0; o < i.length && o < s.length; o++) {
                var u = i[o], a = s[o], f = new e(t, r, u, a);
                n.listeners.push(f);
            }
        },
        ...
        n.dispatchEvent = function (e) {
            var t = e.type, r = e.target, i = n.listeners.slice();
            for (var s = 0; s < i.length; s++) {
                var o = i[s];
...
var rect = function (e) {
    ...
    return t.prototype.x = 0,
        ...
        t.prototype.intersect = function (n) {
            var r = this, i = r.topLeft(), s = r.bottomRight(), o = n.topLeft(), u = n.bottomRight(), a = new e(Math.max(i.x, o.x), Math.max(i.y, o.y)), f = new e(Math.min(s.x, u.x), Math.min(s.y, u.y)), l = new t(0, 0, 0, 0);
...
var paths = function () {
    ...
    return e.prototype.delegate = null,
        e.prototype.rect = function (e) {
            var t = this, n = [e.x, e.y, e.width, e.height];
            t.addCommand("R:" + n.join(","));
        },
        e.prototype.circle = function (e) {
            var t = this, n = [e.center.x, e.center.y, e.radius, 0, Math.PI * 2];
        ...
        e.prototype.addCommand = function (e) {
            ...
            for (var r = 0; r < n.length; r++) {
                var i = n[r], s = i.split(":"), o = t.operationMap(s[0]);
                if (o != null) {
...
var color = function (e) {
    if (e === void 0) { e = string_util; }
    var t = function (e) {
        var t = this;
        if (arguments.length >= 1) {
            var n = e.replace(/^#|^0x/, ""), r = parseInt(n, 16);
    ...
    return t.colorWithString = function (e) {
        ...
        t.randomColor = function (e, n) {
            ...
            var r = e >> 16 & 255, i = e >> 8 & 255, s = e & 255, o = n >> 16 & 255, u = n >> 8 & 255, a = n & 255, f = r + Math.floor(Math.random() * (o - r)), l = r + Math.floor(Math.random() * (u - i)), c = r + Math.floor(Math.random() * (a - s));
        ...
        t.prototype.to24BitString = function (t) {
            ...
            if (n.bit24String == null || n.bit24Updated === !1) {
                var r = e.fillStringTo(n.r().toString(16), "0", 2).toUpperCase(), i = e.fillStringTo(n.g().toString(16), "0", 2).toUpperCase(), s = e.fillStringTo(n.b().toString(16), "0", 2).toUpperCase();
        ...
        t.prototype.to32BitString = function (t) {
            ...
            if (n.bit32String == null || n.bit32Updated === !1) {
                var r = e.fillStringTo(n.r().toString(16), "0", 2).toUpperCase(), i = e.fillStringTo(n.g().toString(16), "0", 2).toUpperCase(), s = e.fillStringTo(n.b().toString(16), "0", 2).toUpperCase(), o = e.fillStringTo(n.a().toString(16), "0", 2).toUpperCase();
                t = arguments.length >= 1 ? t : "#",
        ...
        t.prototype.toRGBString = function () {
            ...
            if (e.rgbString == null || e.rgbStringUpdated === !1) {
                ...
                var t = Math.round(e.r()), n = Math.round(e.g()), r = Math.round(e.b());
        ...
        t.prototype.toRGBAString = function () {
            ...
            if (e.rgbaString == null || e.rgbaStringUpdated === !1) {
                ...
                var t = Math.round(e.r()), n = Math.round(e.g()), r = Math.round(e.b()), i = Math.round(e.a() / 255 * 100) / 100;
        ...
        t.prototype.adjustSaturation = function (e) {
            var t = this, n = (t.r() + t.g() + t.b()) / 3, r = n + (t.r() - n) * e, i = n + (t.g() - n) * e, s = n + (t.b() - n) * e;
            t.r(Math.floor(r)),
                t.g(Math.floor(i)),
                t.b(Math.floor(s)),
                t.bit24Updated = !1,
        ...
        r.init = function (e) {
            ...
            for (var n in t.to)
                if (t.to.hasOwnProperty(n) && typeof t.target[n] == "function") {
                    var r = t.target[n], i = r.call(t.target);
                    t.from[n] = i.clone ? i.clone() : i;
                }
        },
        r.update = function (n) {
            var r = this, i = Math.min(n - r.startTS, r.duration), s = r.easing(i, 0, 1, r.duration);
            for (var o in r.from)
                if (r.from.hasOwnProperty(o)) {
                    var u = r.from[o], a = r.to[o];
                    if (o == "matrix") {
                        var f = new e;
                        f.a = u.a + (a.a - u.a) * s,
                            f.b = u.b + (a.b - u.b) * s,
                        ...
                        var l = u.r() + (a.r() - u.r()) * s, c = u.g() + (a.g() - u.g()) * s, h = u.b() + (a.b() - u.b()) * s, p = u.a() + (a.a() - u.a()) * s;
...
var scale_mode = function (e, t, n) {
    if (e === void 0) { e = mat3; }
    if (t === void 0) { t = vec2; }
    if (n === void 0) { n = align_mode; }
    var r = function () { };
    return r.align = function (e, r, i, s, o) {
        ...
        r.noScale = function (t, n, i, s, o) {
            var u = new e, a = r.align(t, n, i, s, o);
            return u.tx = a.x,
                u.ty = a.y,
                u;
        },
        r.showAll = function (t, n, i, s, o) {
            var u = Math.min(i / t, s / n), a = Math.round(t * u), f = Math.round(n * u), l = new e;
            l.a = a / t,
                l.d = f / n;
        ...
        r.noBorder = function (t, n, i, s, o) {
            var u = Math.max(i / t, s / n), a = Math.round(t * u), f = Math.round(n * u), l = new e;
            l.a = a / t,
                l.d = f / n;
            var c = r.align(a, f, i, s, o);
            return l.tx = c.x,
        ...
        r.fitWidth = function (t, n, i, s, o) {
            var u = i / t, a = Math.round(t * u), f = Math.round(n * u), l = new e;
            l.a = a / t,
                l.d = f / n;
            var c = r.align(a, f, i, s, o);
            return l.tx = c.x,
        ...
        r.fitHeight = function (t, n, i, s, o) {
            var u = s / n, a = Math.round(t * u), f = Math.round(n * u), l = new e;
            l.a = a / t,
                l.d = f / n;
            var c = r.align(a, f, i, s, o);
            return l.tx = c.x,
...
var view = function (e, t, n, r, i, s, o, u, a, f, l, c, h) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = mat3; }
    if (n === void 0) { n = rect; }
    if (r === void 0) { r = vec2; }
    if (i === void 0) { i = paths; }
    if (s === void 0) { s = animate; }
    if (o === void 0) { o = color; }
    if (u === void 0) { u = event; }
    if (a === void 0) { a = event_center; }
    if (f === void 0) { f = touch; }
    if (l === void 0) { l = touch_event; }
    if (c === void 0) { c = scale_mode; }
    if (h === void 0) { h = align_mode; }
    var p = function () { };
    return p.viewIndex = 0,
        ...
        p.prototype.updatePropsFromXML = function (e) {
            ...
            if (e.is("[matrix]")) {
                ...
                var f = e.is("[scale-x]") ? parseFloat(e.attr("scale-x")) : 1, l = e.is("[scale-y]") ? parseFloat(e.attr("scale-y")) : 1, p = e.is("[rotation]") ? parseFloat(e.attr("rotation")) * (Math.PI / 180) : 0, d = e.is("[x]") ? parseFloat(e.attr("x")) : 0, v = e.is("[y]") ? parseFloat(e.attr("y")) : 0;
                u.a = f * Math.cos(p),
                    u.b = Math.sin(p),
                    u.c = -1 * Math.sin(p),
                    u.d = l * Math.cos(p),
        ...
        p.prototype.scaleX = function (e) {
            var t = this, n = t.matrix(), r = t.radian(), i = n.a / Math.cos(r);
        ...
        p.prototype.scaleY = function (e) {
            var t = this, n = t.matrix(), r = t.radian(), i = n.d / Math.cos(r);
            return arguments.length > 0 && (i = e,
                n = n.clone(),
                n.d = i * Math.cos(r),
                t.matrix(n)),
        ...
        p.prototype.radian = function (e) {
            var t = this, n = t.matrix(), r = Math.asin(n.b);
        ...
        p.prototype.rect = function (e) {
            var t = this, i = new r(0, 0), s = new r(t.width(), 0), o = new r(0, t.height()), u = new r(t.width(), t.height()), a = arguments.length > 0 ? t.matrixTo(e) : t.matrixTo(), f = null;
            if (a != null) {
                var l = a.transformPoint(i), c = a.transformPoint(s), h = a.transformPoint(o), p = a.transformPoint(u), d = Math.min(l.x, c.x, h.x, p.x), v = Math.max(l.x, c.x, h.x, p.x), m = Math.min(l.y, c.y, h.y, p.y), g = Math.max(l.y, c.y, h.y, p.y);
                f = new n(d, m, v - d, g - m);
            }
            return f;
        },
        p.prototype.convertTouches = function (e) {
            var t = this, n = [], i = t.matrixTo(e.target);
        ...
        p.prototype.triggerEvent = function (e) {
            ...
            if (t.enabled() && t.visible()) {
                ...
                if (e.type == l.TOUCH_START) {
                    var s = t.rect(e.target), o = e.touches[0], u = new r(o.x, o.y);
                    ...
                    var f = t.lastEvent, c = t.startEvent;
                    t.lastEvent = null,
                        t.startEvent = null,
                        n = !0,
                    ...
                    if (f.type == l.TOUCH_MOVE && f.timeStamp - c.timeStamp < 500 && f.touches.length <= 1 && c.touches.length <= 1) {
                        var h = new r(c.touches[0].stageX, c.touches[0].stageY), p = new r(f.touches[0].stageX, f.touches[0].stageY);
        ...
        p.prototype.resize = function (e, t) {
            ...
            if (n.alignMode() != null && n.scaleMode() != null) {
                var r = n.alignMode(), i = n.scaleMode(), s = i(n.width(), n.height(), e, t, r);
                n.matrix(s);
            }
...
var view_container = function (e, t, n) {
    if (e === void 0) { e = view; }
    if (t === void 0) { t = rect; }
    if (n === void 0) { n = view_factory; }
    var r = function () { };
    return r.prototype = new e,
        ...
        r.prototype.updatePropsFromXML = function (t) {
            ...
            var i = t.find("> *");
            i.each(function (e, t) {
                var i = $(t), s = i[0].nodeName.toLowerCase(), o = n.createViewByNodeName(s);
                o != null && (o.updatePropsFromXML(i),
                    r.addSubView(o));
            });
        },
        r.prototype.needToRender = function (t) {
            var n = this, r, i = n.subViews();
            if (arguments.length > 0)
        ...
        r.prototype.empty = function () {
            var e = this, t = e.subViews().slice(0);
        ...
        r.prototype.eachSubView = function (e) {
            var t = this, n = t.subViews().slice();
            for (var r = 0; r < n.length; r++) {
                var i = n[r], s = e.call(null, r, i);
                if (s === !1)
                    break;
            }
        },
        ...
        r.prototype.triggerSubViewEvent = function (e) {
            var t = this, n = !1, r = t.subViews();
            for (var i = r.length - 1; i >= 0; i--) {
                var s = r[i], o = s.triggerEvent(e);
                if (o) {
                    n = o;
                    break;
                }
        ...
        r.prototype.active = function (t) {
            var n = this, r = e.prototype.active.call(n, t);
...
var stage = function (e, t, n, r, i, s, o) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = mat3; }
    if (n === void 0) { n = view_container; }
    if (r === void 0) { r = scale_mode; }
    if (i === void 0) { i = align_mode; }
    if (s === void 0) { s = orientation; }
    if (o === void 0) { o = rect; }
    var u = function () { };
    u.prototype = new n;
    var a = u.prototype;
...
var assets_config = function () {
    var e = function () { };
    return e.baseURI = "./",
        e;
};
var asset_types = function () {
    var e = function () { };
...
var base64_js = function () {
    ...
    return function (e) {
        ...
        var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", n = typeof Uint8Array != "undefined" ? Uint8Array : Array, r = "+".charCodeAt(0), i = "/".charCodeAt(0), s = "0".charCodeAt(0), o = "a".charCodeAt(0), u = "A".charCodeAt(0), a = "-".charCodeAt(0), f = "_".charCodeAt(0);
        e.toByteArray = c,
            e.fromByteArray = h;
    }(e),
        e;
};
var asset_item = function (e, t, n, r, i, s, o, u, a) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = assets_config; }
    if (r === void 0) { r = asset_types; }
    if (i === void 0) { i = system; }
    if (s === void 0) { s = event; }
    if (o === void 0) { o = progress_event; }
    if (u === void 0) { u = error_event; }
    if (a === void 0) { a = base64_js; }
    var f = function (e) {
        if (arguments.length <= 0)
            return;
        var t = this;
        ...
        var o = /^\w+\|/;
        if (o.test(e)) {
            var u = e.split("|"), a = u.slice(1), f = a.join("|");
            u = u.slice(0, 1),
                u = u.concat(f),
                t.type = u[0],
                t.uri = u[1];
    ...
    return l.referenceCount = 0,
        ...
        l.configLoadURL = function (e) {
            var t = this, r = /^abs:/gi, i = /^https*/gi, s = /^\//gi, o = /^\.\//gi;
        ...
        l.htmlLoader = function () {
            var t = this, n = function (n) {
                var r = e(n), i = r.find("div[pre-load]");
        ...
        l.axeLoader = function () {
            var e = this, n = function (t) {
                var n = t.currentTarget, r = n.response, i = new DataView(r), s = 0, o = [], u = [], f = [];
                ...
                var m = 0, g = window.URL || window.webkitURL || window, y = function () {
                    if (m >= f.length)
                        e.multipleAssetLoaded(o, u);
                    else {
                        var t = f[m], n = document.createElement("img");
                        n.onload = function (e) {
                            try {
                        ...
                        try {
                            ...
                            var i = o[m].substr(o[m].length - 3, 3).toLowerCase(), s;
...
var url_util = function (e) {
    if (e === void 0) { e = jquery_1["default"]; }
    var t = function () { };
    return t.origin = function () {
        var e = String(window.location.href), t = /^http[s]?:\/\/[^\/]*\/{1}/, n = null;
        return t.test(e) ? n = e.match(t)[0] : n = e + "/",
            n;
    },
        t.relativePath = function (e) {
            var n = t.cleanURL(), r = n.split("/");
            r.pop();
            var i = e.split("/");
            for (var s = 0; s < i.length; s++) {
                var o = i[s];
        ...
        t.cleanURL = function () {
            var e = String(window.location.href), t = e.split("#");
            return t[0];
        },
        t.hash = function (e) {
            if (arguments.length > 0) {
            ...
            var r = String(window.location.href), i = r.split("#"), s = null;
        ...
        t.decodeParams = function (t) {
            ...
            if (t != null) {
                ...
                e.each(r, function (e, t) {
                    var r = t.split("=")[0], i = decodeURIComponent(t.split("=")[1]);
                    n[r] = i;
                });
            }
            return n;
        ...
        t.splitURLs = function (e) {
            var t = /\[\d+-\d+\]/, n = e.match(t), r = [];
            if (n != null) {
                n = n[0];
                var i = n.slice(1, n.length - 1).split("-"), s = i[0], o = i[1], u = Math.max(s.length, o.length);
                s = parseInt(s, 10),
                    o = parseInt(o, 10);
                for (var a = s; a <= o; a++) {
                    var f = String(a);
...
var assets_loader = function (e, t, n, r, i, s, o, u, a) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = system; }
    if (n === void 0) { n = event_center; }
    if (r === void 0) { r = asset_item; }
    if (i === void 0) { i = progress_event; }
    if (s === void 0) { s = event; }
    if (o === void 0) { o = error_event; }
    if (u === void 0) { u = url_util; }
    if (a === void 0) { a = asset_types; }
    var f = function (e) {
        var t = this;
    ...
    return l.assets = null,
        ...
        l.onAssetLoaded = function (e) {
            ...
            if (u.type == a.AXE)
                for (var l = 0; l < u.assetImages.length; l++) {
                    var c = u.assetPaths[l], h = u.assetImages[l], p = new r;
                    p.assetLoaded(h),
        ...
        l.onAssetLoadProgress = function () {
            var e = this, t = e.loadProgress(), r = new i(e, t);
            n.dispatchEvent(r);
        },
...
var movie = function (e, t, n, r, i) {
    if (e === void 0) { e = view; }
    if (t === void 0) { t = assets_loader; }
    if (n === void 0) { n = url_util; }
    if (r === void 0) { r = event; }
    if (i === void 0) { i = event_center; }
    ...
    return o.prototype = new e,
        ...
        o.prototype.updatePropsFromXML = function (r) {
            ...
            var s = r.find("> frame"), o = i.frames();
            s.each(function (e, r) {
                var i = $(r), s = i.is("[repeat]") ? parseInt(i.attr("repeat"), 10) : 1;
                for (var u = 0; u < s; u++) {
                    var a = i.text(), f = n.splitURLs(a);
            ...
            var u = r.find("> script");
            u.each(function (e, t) {
                var n = $(t), r = n.attr("frame").toLowerCase(), s;
                r == "first" ? s = 0 : r == "last" ? s = i.framesCount() - 1 : s = parseInt(r, 10);
                if (isNaN(s))
                    return;
                var o = n.attr("action"), u = o.split(":"), a = u[0], f = i[a];
        ...
        o.prototype.removeAction = function (e) {
            var t = this, n = t.frameActions(e.frame);
            if (n != null)
                for (var r = 0; r < n.length; r++)
                    if (n[r] == e) {
                        n.splice(r, 1);
        ...
        o.prototype.update = function (t, n) {
            ...
            if (s.playing && (s.pauseWhenAnimating() === !1 || s.animating() === !1)) {
                var o = n * s.frameRate(), u = Math.floor(s._currentFrame + o), a = s.currentFrame(), f = u - a, l = s._currentFrame + o - u;
                for (var c = 0; c < f; c++) {
                    var h = s.currentFrame(), p = s.frameActions(h);
                    if (p != null)
...
var text = function (e, t, n, r, i) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = view; }
    if (n === void 0) { n = color; }
    if (r === void 0) { r = text_align; }
    if (i === void 0) { i = text_v_align; }
    var s = function () { };
    s.prototype = new t;
    var o = s.prototype;
...
var button = function (e, t, n, r, i) {
    if (e === void 0) { e = view_container; }
    if (t === void 0) { t = button_state; }
    if (n === void 0) { n = event_center; }
    if (r === void 0) { r = touch_event; }
    if (i === void 0) { i = event; }
    var s = function () { };
    s.prototype = new e;
    var o = s.prototype;
    return s.prototype.constructor = s,
        ...
        s.prototype.enabled = function (t) {
            var n = this, r = e.prototype.enabled.call(n, t);
...
var motion_frame = function (Mat3, BBColor) {
    if (Mat3 === void 0) { Mat3 = mat3; }
    if (BBColor === void 0) { BBColor = color; }
    var AXEMotionFrame = function () { }, pt = AXEMotionFrame.prototype;
    return pt.constructor = AXEMotionFrame,
        ...
        pt.updateFromXML = function ($xml) {
            ...
            if ($xml.is("[matrix]")) {
                ...
                var scaleX = $xml.is("[scale-x]") ? parseFloat($xml.attr("scale-x")) : 1, scaleY = $xml.is("[scale-y]") ? parseFloat($xml.attr("scale-y")) : 1, rotation = $xml.is("[rotation]") ? parseFloat($xml.attr("rotation")) * (Math.PI / 180) : 0, x = $xml.is("[x]") ? parseFloat($xml.attr("x")) : 0, y = $xml.is("[y]") ? parseFloat($xml.attr("y")) : 0;
        ...
        pt.clone = function () {
            var e = this, t = new AXEMotionFrame;
...
var motion_layer = function (e, t, n, r, i) {
    if (e === void 0) { e = motion_frame; }
    if (t === void 0) { t = mat3; }
    if (n === void 0) { n = view_factory; }
    if (r === void 0) { r = color; }
    if (i === void 0) { i = vec2; }
    var s = function () { }, o = s.prototype;
    return o.constructor = s,
        o.contentView = null,
        o.updateFromXML = function (t) {
            var r = this, i = t.find("> content > *");
            if (i.length > 0) {
        ...
        o.calculateRotation = function (e, n, r) {
            var s = new i(e.width() / 2, e.height() / 2), o = new t;
        ...
        o.contentWithTime = function (e) {
            ...
            if (s != null && s.isBlank == 0) {
                ...
                if (s.tween == null || o == null)
                    ...
                    var l = o.time - s.time, c = e - s.time;
                    ...
                    if (s.rotation != null && o.rotation != null) {
                        ...
                        var m = s.matrix, g = o.matrix, y = new t;
...
var motion = function (e, t, n, r, i, event) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = system; }
    if (n === void 0) { n = view_container; }
    if (r === void 0) { r = motion_layer; }
    if (i === void 0) { i = event_center; }
    if (event === void 0) { event = s; }
    var o = function () { };
    o.prototype = new n;
    var u = o.prototype;
...
var scroll_bar = function (e, t, n, r, i) {
    if (e === void 0) { e = view_container; }
    if (t === void 0) { t = shape; }
    if (n === void 0) { n = color; }
    if (r === void 0) { r = circle; }
    if (i === void 0) { i = rect; }
    var s = function (e) {
        var t = this;
        t.isVertical = e;
    ...
    return s.prototype = new e,
        ...
        s.prototype.updateSize = function () {
            ...
            if (e.scrollView != null) {
                var t = e.barView(), n = 0, s = 0, o = 0, u = 0;
                if (e.isVertical) {
...
var scroll_view = function (e, t, n, r, i, s, o) {
    if (e === void 0) { e = system; }
    if (t === void 0) { t = view; }
    if (n === void 0) { n = vec2; }
    if (r === void 0) { r = scroll_bar_style; }
    if (i === void 0) { i = scroll_bar; }
    if (s === void 0) { s = event_center; }
    if (o === void 0) { o = touch_event; }
    var u = {};
    ...
    return a.prototype = new t,
        ...
        a.prototype.updatePropsFromXML = function (e) {
            ...
            if (e.is("[offset]")) {
                var o = e.attr("offset").split(","), u = new n(parseFloat(o[0]), parseFloat(o[1]));
                i.offset(u);
            }
            if (e.is("[content-size]")) {
                var a = e.attr("content-size").split(","), f = new n(parseFloat(a[0]), parseFloat(a[1]));
                i.contentSize(f);
            }
        ...
        a.prototype.update = function (e, r) {
            ...
            if (i.easingInitSpeed != null) {
                var o = e - i.easingStartTs, u = i.offset().clone();
        ...
        a.prototype.onViewScrolling = function (e) {
            var t = this, i = new n(e.touches[0].x, e.touches[0].y), s = t.offset().clone(), o = new n;
        ...
        a.prototype.onViewScrollEnd = function () {
            var e = this, t = e.offset().clone(), r = t.clone(), i = 0, u = 0, a = 0, f = 0, l = e.currentSpeed.clone();
            t.x < 0 ? (r.x = 0,
...
var table_view = function (e, t, n) {
    if (e === void 0) { e = scroll_view; }
    if (t === void 0) { t = rect; }
    if (n === void 0) { n = vec2; }
    var r = {};
    ...
    return i.prototype = new e,
        ...
        i.prototype.renderVertical = function () {
            var e = this, t = new n(e.offset().y, e.offset().y + e.height()), r = [], i = 0;
            for (var s = 0; s < e.dataSource().cellCount(e); s++) {
                var o = e.dataSource().cellSizeByIndex(e, s), u = new n(i, i + o), a = u.y < t.x || u.x > t.y;
                if (a == 0) {
        ...
        i.prototype.renderHorizontal = function () {
            var e = this, t = new n(e.offset().x, e.offset().x + e.width()), r = [], i = 0;
            for (var s = 0; s < e.dataSource().cellCount(e); s++) {
                var o = e.dataSource().cellSizeByIndex(e, s), u = new n(i, i + o), a = u.y < t.x || u.x > t.y;
                if (a == 0) {
                    var f = e.dataSource().cellByIndex(e, s);
...
var spin_view = function (e, t) {
    ...
    return r.constructor = n,
        ...
        r.update = function (n, r) {
            ...
            if (i.angleChanged) {
                i.angleChanged = !1;
                var o = i.angle() * (Math.PI / 180), u = new t;
                u.a = Math.cos(o),
                    u.b = Math.sin(o),
                    u.c = -1 * u.b,
                    u.d = u.a,
...
var axe = function (e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
    if (e === void 0) { e = render_engine; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = event; }
    if (r === void 0) { r = stage; }
    if (i === void 0) { i = view_container; }
    if (s === void 0) { s = view; }
    if (o === void 0) { o = bitmap; }
    if (u === void 0) { u = shape; }
    if (a === void 0) { a = movie; }
    if (f === void 0) { f = text; }
    if (l === void 0) { l = button; }
    if (c === void 0) { c = motion; }
    if (h === void 0) { h = scroll_view; }
    if (p === void 0) { p = table_view; }
    if (d === void 0) { d = spin_view; }
    if (v === void 0) { v = view_factory; }
...
var view_ctrl = function (e, t, n, r, i, s, o) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = view_container; }
    if (n === void 0) { n = assets_loader; }
    if (r === void 0) { r = event_center; }
    if (i === void 0) { i = event; }
    if (s === void 0) { s = progress_event; }
    if (o === void 0) { o = error_event; }
    var u = function (e) {
        var t = this;
...
var stage_ctrl = function (e, t) {
    if (e === void 0) { e = view_ctrl; }
    if (t === void 0) { t = stage; }
    var n = function () { };
...
var section_cell = function (e, t, n) {
    if (e === void 0) { e = view_ctrl; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = event; }
    var r = function (e) {
...
var button_group = function (e, t, n, r) {
    if (e === void 0) { e = event_center; }
    if (t === void 0) { t = touch_event; }
    if (n === void 0) { n = button_state; }
    if (r === void 0) { r = event; }
    var i = function () { };
    return i.prototype.constructor = i,
        ...
        i.prototype.selectButtonByIndex = function (e) {
            var t = this, n = t.buttonByIndex(e);
...
var head_kv = function (e, t, n, r, i, s, o, u) {
    if (e === void 0) { e = kv_motion; }
    if (t === void 0) { t = button_group; }
    if (n === void 0) { n = event_center; }
    if (r === void 0) { r = event; }
    if (i === void 0) { i = system; }
    if (s === void 0) { s = vec2; }
    if (o === void 0) { o = movie; }
    if (u === void 0) { u = audio_ctrl; }
    ...
    a.prototype.constructor = a,
        ...
        a.prototype.distance = function (e) {
            var t = this, n = new s(t.x, t.y), r = new s(e.x, e.y);
            return n.distance(r);
        },
        ...
        a.prototype.getMotionFrames = function (e) {
            var t = this, n = e[t.motionIndex], r = n.frames().slice(t.beginFrame, t.endFrame + 1);
            return t.reversion && (r = r.reverse()),
                r;
        },
        a.prototype.reverse = function () {
            var e = this, t = new a(e.name, e.motionIndex, e.beginFrame, e.endFrame, e.x, e.y, !e.reversion);
            return t.toNodes = e.toNodes.slice(),
                t;
        };
    var f = new a("DEF_LOOP", 0, 0, 14, 0, 0), l = new a("DEF_TRANSITION", 0, 15, 28, 0, 1), c = l.reverse(), h = new a("MC1_TRANSITION", 1, 0, 6, 0, 2), p = h.reverse(), d = new a("MC1_LOOP", 1, 7, 20, 0, 3);
    h.soundEffect("sounds/head_1.mp3");
    var v = new a("MC2_TRANSITION", 2, 0, 6, 1, 2), m = v.reverse(), g = new a("MC2_LOOP", 2, 7, 20, 1, 3);
    v.soundEffect("sounds/head_2.mp3");
    var y = new a("MC3_TRANSITION", 3, 0, 6, 2, 2), b = y.reverse(), w = new a("MC3_LOOP", 3, 7, 20, 2, 3);
    y.soundEffect("sounds/head_3.mp3");
    var E = new a("MC4_TRANSITION", 4, 0, 6, 3, 2), S = E.reverse(), x = new a("MC4_LOOP", 4, 7, 20, 3, 3);
    ...
    return N.prototype = new e,
        ...
        N.prototype.createPathFromNodes = function (e, t) {
            var n = this, r = null, i = e.toNodes.slice();
...
var section_head = function (e, t) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = head_kv; }
    var n = function (t) {
        var n = this;
...
var star_kv = function (e, t, n, r, i) {
    if (e === void 0) { e = kv_motion; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = event; }
    if (r === void 0) { r = touch_event; }
    if (i === void 0) { i = audio_ctrl; }
    var s = function (e) {
        var t = this;
        t.starName = e;
    };
...
var section_naying = function (e, t) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = star_kv; }
    var n = function (t) {
        var n = this;
        e.prototype.constructor.call(n, t);
    };
...
var section_wangfeng = function (e, t) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = star_kv; }
    var n = function (t) {
        var n = this;
...
var section_harlern = function (e, t) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = star_kv; }
    var n = function (t) {
        var n = this;
...
var bottom_kv = function (e, t, n, r, i) {
    if (e === void 0) { e = kv_motion; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = touch_event; }
    if (r === void 0) { r = event; }
    if (i === void 0) { i = audio_ctrl; }
    var s = function () { };
    return s.prototype = new e,
...
var section_bottom = function (e, t) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = bottom_kv; }
    var n = function (t) {
        var n = this;
        e.prototype.constructor.call(n, t);
    };
...
var jQueryCookie = function (e) {
    if (e === void 0) { e = jquery_1["default"]; }
    jquery_1["default"].cookie = function (e, t, n) {
        if (arguments.length > 1 && String(t) !== "[object Object]") {
            n = jquery_1["default"].extend({}, n);
...
var voc_constants = function (e, t) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = jQueryCookie; }
    var n = {};
...
var section_footer = function (e, t, n, r, i, s) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = event_center; }
    if (n === void 0) { n = touch_event; }
    if (r === void 0) { r = event; }
    if (i === void 0) { i = voc_constants; }
    if (s === void 0) { s = button_state; }
    var o = function (t) {
        var n = this;
        e.prototype.constructor.call(n, t);
    };
...
var section_top = function (e, t, n, r, i) {
    if (e === void 0) { e = section_cell; }
    if (t === void 0) { t = star_kv; }
    if (n === void 0) { n = event_center; }
    if (r === void 0) { r = touch_event; }
...
var wechat_api = function (e, t, n, r, i, s) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = jweixin; }
    if (n === void 0) { n = system; }
    if (r === void 0) { r = url_util; }
    if (i === void 0) { i = event_center; }
    if (s === void 0) { s = wechat_event; }
    var o = function () { };
    o._instance = null,
        o.instance = function () {
...
var voice_of_china = function (e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
    if (e === void 0) { e = stage_ctrl; }
    if (t === void 0) { t = assets_loader; }
    if (n === void 0) { n = section_cell; }
    if (r === void 0) { r = section_head; }
    if (i === void 0) { i = section_naying; }
    if (s === void 0) { s = secion_jay; }
    if (o === void 0) { o = section_wangfeng; }
    if (u === void 0) { u = section_harlern; }
    if (a === void 0) { a = section_bottom; }
    if (f === void 0) { f = section_footer; }
    if (l === void 0) { l = section_top; }
    if (c === void 0) { c = wechat_api; }
    if (h === void 0) { h = wechat_event; }
    if (p === void 0) { p = event_center; }
    if (d === void 0) { d = url_util; }
    if (v === void 0) { v = voc_constants; }
    var m = function () {
        var e = this;
        t.threadsCount = 1;
        var n = c.instance();
        ...
        g.onViewResize = function (e, t) {
            ...
            if (n.prepared) {
                ...
                for (var r = 0; r < n.cells.length; r++) {
                    var i = n.cells[r].view(), s = e / i.width();
                    i.scaleX(s),
                        i.scaleY(s);
                }
...
var main = function (e, t, n) {
    if (e === void 0) { e = jquery_1["default"]; }
    if (t === void 0) { t = axe; }
    if (n === void 0) { n = voice_of_china; }
